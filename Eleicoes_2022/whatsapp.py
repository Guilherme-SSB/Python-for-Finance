...
class WhatsApp(object):
    def __init__(self, browser=None, time_out=600):
        ...
        if not browser:
            browser = webdriver.Chrome(
                # ChromeDriverManager(version='104.0.5112.29').install(),
    ...
    def find_by_username(self, username):
        ...
        try:
            opened_chat = self.browser.find_elements(By.XPATH, '//div[@id="main"]/header/div[2]/div[1]/div[1]/span')
            if len(opened_chat):
    ...
    def get_last_message_received(self, query: str):
        ...
        try:
            ...
            if self.find_by_username(query):
                ...
                list_of_messages = self.browser.find_elements(By.XPATH, '//div[@id="main"]/div[3]/div[1]/div[2]/div[3]/child::div[contains(@class,"message-in")]')
